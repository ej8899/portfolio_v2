          ...
          <ul id='skillcards'>
            <li className='skillcard' id='card_1'>
              <div className='skill-card__content skill-card'>
                ...
                <p>
                  ...
                  lacking. MongoDB seems to have largely solved the performance issues while giving
            ...
            <li className='skillcard' id='card_4'>
              <div className='skill-card__content skill-card'>
                ...
                <p>
                  Although I utilize AI on a daily basis as a coding assistant and even as a general
                  ...
                  projects that I&apos;d like to add an AI componenent to them. Updates will be soon
                  enough!
                </p>
              </div>
            </li>
